...
int main(int argc, char *argv[]) {
    ...
    printf("Chave privada em formato binário:\n");
    for (size_t i = 0; i < sizeof(private_key); i++) {
        printf("%02x", private_key[i]);
    }
    printf("\n");

    // Aqui você pode adicionar código para fazer algo com a chave privada
    // Por exemplo: gerar um endereço Bitcoin, assinar uma transação, etc.
